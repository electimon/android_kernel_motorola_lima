 ...
 *
 * $Revision: 34228 $
 * $Date: 2018-09-25 13:41:36 +0800 (週二, 25 九月 2018) $
 *
...
static int32_t nvt_selftest_open(struct inode *inode, struct file *file)
{
	...
	/* ---Download MP FW--- */
	nvt_update_firmware(ts->mp_firmware_name);
